...
mkdir -p ~/.icons/default/ && ln -s /usr/share/icons/Bibata-Original-Ice/* ~/.icons/default/
...
### Packages
sudo apt install -y gnome-disk-utility evince kodi kodi-pvr-iptvsimple kodi-inputstream-ffmpegdirect pulseaudio-equalizer neovim ristretto nextcloud-desktop cherrytree vlc synaptic snapd telegram-desktop